package com.example.submission1fundamental.fragment
...
import com.example.submission1fundamental.activity.DetailUser
import com.example.submission1fundamental.model.User
import com.example.submission1fundamental.adapter.UserAdapter
import com.example.submission1fundamental.databinding.FragmentFollowersBinding
import com.example.submission1fundamental.viewModel.MainViewModel
...
class FollowersFragment : Fragment() {
    ...
    private fun showRecyclerList() {
        ...
        mainViewModel.getFollowers().observe(requireActivity(), { data ->
            if (data != null) {
